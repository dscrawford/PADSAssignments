...
We also want to look into geographical data, since location is very important to housing value.
```{r}
# Geographical map
...
mhv_map
```
We see from the first map that houses close to ocean have above average value.

(We may need some more analysis on the plot1)
...
mi_map
```
(We may need some more analysis on the plot2)
...
hs_map
```
(We may need some more analysis on the plot3)
